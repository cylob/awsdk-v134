...
/*-----------------------------------------------------------------------------
                  Copyright 1998-2020 Activeworlds Inc.
...
#define AW_BUILD                    134 // AW 7.0 (133 AW 6.7) (127 // AW 6.6)
...
#define AW_OBJECT_VERSION_CLOTH       1
    ...
    typedef enum {
        ...
        AW_LICENSE_OWNER,
        AW_WORLD_OWNER_CAPABILITY,

        AW_WORLD_RIGHTS_OFFERED,
        AW_WORLD_RIGHTS_ENTER_COSTS,
        AW_WORLD_RIGHTS_BUILD_COSTS,
        AW_WORLD_RIGHTS_V4_OBJS_COSTS,
        AW_WORLD_RIGHTS_SPECIAL_OBJS_COSTS,
        AW_WORLD_RIGHTS_SPECIAL_CMDS_COSTS,
        ...
        AW_DLG_ORIGINATOR_SESSION,
        AW_DLG_RECIPIENT_SESSION,
        AW_DLG_REFERENCE,
        AW_DLG_OPTION,
        AW_DLG_TITLE,
        AW_DLG_TEXT,

        AW_DLG_ANSWER_ORIGINATOR_SESSION,
        AW_DLG_ANSWER_RECIPIENT_SESSION,
        AW_DLG_ANSWER_REFERENCE,
        AW_DLG_ANSWER_OPTION,
        AW_DLG_ANSWER_TEXT,

        AW_WORLD_WATER_USE_SHADERS,
        AW_WORLD_WATER_SURFACE_COLOR,
        AW_WORLD_WATER_TINT_COLOR,
        AW_WORLD_WATER_WAVELET_SPEED,
        AW_WORLD_WATER_WAVELET_DIRECTION_X,
        AW_WORLD_WATER_WAVELET_DIRECTION_Z,
        AW_WORLD_WATER_WAVELET_HEIGHT,
        AW_WORLD_WATER_WAVE1_SPEED,
        AW_WORLD_WATER_WAVE1_DIRECTION_X,
        AW_WORLD_WATER_WAVE1_DIRECTION_Z,
        AW_WORLD_WATER_WAVE1_HEIGHT,
        AW_WORLD_WATER_WAVE2_SPEED,
        AW_WORLD_WATER_WAVE2_DIRECTION_X,
        AW_WORLD_WATER_WAVE2_DIRECTION_Z,
        AW_WORLD_WATER_WAVE2_HEIGHT,
        AW_WORLD_WATER_WAVE3_SPEED,
        AW_WORLD_WATER_WAVE3_DIRECTION_X,
        AW_WORLD_WATER_WAVE3_DIRECTION_Z,
        AW_WORLD_WATER_WAVE3_HEIGHT,
        AW_WORLD_WATER_WAVE4_SPEED,
        AW_WORLD_WATER_WAVE4_DIRECTION_X,
        AW_WORLD_WATER_WAVE4_DIRECTION_Z,
        AW_WORLD_WATER_WAVE4_HEIGHT,
        AW_WORLD_AUTO_CUBEMAP,
        AW_WORLD_AUTO_CUBEMAP_QUALITY,
        AW_WORLD_AUTO_CUBEMAP_INTERVAL,
        AW_WORLD_WATER_REFLECTION_HIGHLIGHT,
        AW_WORLD_WATER_SHALLOW_DEPTH,
        AW_WORLD_WATER_SHALLOW_INTENSITY,
        AW_WORLD_WATER_SHALLOW_DISTORTION,
        AW_WORLD_WATER_SHALLOW_SCALE,
        AW_WORLD_WATER_GRID_SCALE,

        AW_UNIVERSE_BUY_CREDITS_URL,
        AW_CITIZEN_ONLINE_STATE,
        AW_CITIZEN_TITLE_NUMBER,
        AW_CITIZEN_TITLE_STARS,
        AW_UNIVERSE_IMMIGRATE_URL,
        AW_CITIZEN_SESSION,

        AW_CHAT_TARGET_TYPES,
        AW_CHAT_TARGET_SESSION,
        ...
        AW_LICENSE_LAST_PORT,
        AW_LICENSE_LAST_STOP,

        AW_CONTACT_LAST_SEEN,

        AW_WORLD_DISABLE_BALLOONS,
        AW_WORLD_MAXIMUM_VISIBILITY,

        AW_TELEGRAM_JOURNAL_START,
        AW_TELEGRAM_JOURNAL_END,
        AW_TELEGRAM_STATUS,
    ...
    typedef enum {
        ...
        AW_EVENT_PURCHASE_OFFER,

        AW_EVENT_DIALOG,
        AW_EVENT_DIALOG_ANSWER,

        AW_EVENT_TELEGRAM_PENDING,
        AW_EVENT_TELEGRAM_JOURNAL,
        AW_EVENT_TELEGRAM_JOURNAL_GET,
    ...
    typedef enum {
        ...
        AW_CALLBACK_PURCHASE_RESULT,
        AW_CALLBACK_SHOPITEM_LIST,
        AW_CALLBACK_CITIZEN_TITLE_RESULT,
        AW_MAX_CALLBACK
    } AW_CALLBACK;
    ...
    typedef enum {
        AW_CHAT_TARGET_ALL = 0x00000000,  // backward compatibility, defaults to ALL
        AW_CHAT_TARGET_CITIZENS = 0x00000001,  // Users only, exluding bots
        AW_CHAT_TARGET_BOTS = 0x00000002,  // Bots only, exluding users
        AW_CHAT_TARGET_TOURISTS = 0x00000004,  // Users only, exluding bots
    } AW_CHAT_TARGETS;
    ...
    // AW_CITRIGHT_TYPE
    typedef enum {
        AW_CITRIGHT_NONE = 0x00000000,
        AW_CITRIGHT_ENTER = 0x00000001,
        AW_CITRIGHT_BUILD = 0x00000002,
        AW_CITRIGHT_TERRAIN = 0x00000004,
        AW_CITRIGHT_EMINENT_DOMAIN = 0x00000008,
        AW_CITRIGHT_V4_OBJECTS = 0x00000010,
        AW_CITRIGHT_SPECIAL_OBJECTS = 0x00000020,
        AW_CITRIGHT_SPECIAL_COMMANDS = 0x00000040,
        AW_CITRIGHT_PUBLIC_SPEAKER = 0x00000080,
        AW_CITRIGHT_EJECT = 0x00000100,
        AW_CITRIGHT_BOTS = 0x00000200,
        AW_CITRIGHT_SPEAK = 0x00000400,
        AW_CITRIGHT_VOIP = 0x00000800,
    } AW_CITRIGHT_TYPES_ENUM;

    // AW_DLG_OPTION
    typedef enum {
        AW_DLG_OPTION_YES = 0x00000001,
        AW_DLG_OPTION_NO = 0x00000002,
        AW_DLG_OPTION_OK = 0x00000004,
        AW_DLG_OPTION_CANCEL = 0x00000008,
        AW_DLG_OPTION_TEXT = 0x00000010,
        AW_DLG_OPTION_BUSY = 0x10000000,
        AW_DLG_OPTION_TIMEOUT = 0x20000000,
    } AW_DLG_OPTION_TYPES;

    // AW_*_AUTO_CUBEMAP
    typedef enum {
        AW_RENDER_CUBEMAP_SKY = 0x00000001,
        AW_RENDER_CUBEMAP_CLOUDS = 0x00000002,
        AW_RENDER_CUBEMAP_TERRAIN = 0x00000004,
        AW_RENDER_CUBEMAP_GROUND = 0x00000008,
        AW_RENDER_CUBEMAP_STATIC_OBJECTS = 0x00000010,
        AW_RENDER_CUBEMAP_OBJECTS = 0x00000020,
    } AW_RENDER_CUBEMAP_TYPES;

    typedef enum {
        AW_ATTRIB_TYPE_INTEGER = 0,
        AW_ATTRIB_TYPE_STRING = 1,
        AW_ATTRIB_TYPE_LONG_STRING = 2,
        AW_ATTRIB_TYPE_BOOLEAN = 3,
        AW_ATTRIB_TYPE_FLOAT = 4,
        AW_ATTRIB_TYPE_DATA = 5,
        AW_ATTRIB_TYPE_LONG_DATA = 6,
        AW_ATTRIB_TYPE_INTEGER64 = 7,
        AW_ATTRIB_TYPE_DOUBLE = 8,
        AW_ATTRIB_TYPE_IN128_ADDR = 9,
        AW_ATTRIB_TYPE_MAX = 9,
    } AW_ATTRIB_TYPES;
...
#pragma pack (1)
    ...
    typedef struct aw_object_data_particles {
        ...
        unsigned int          release_min;      // time in ms
        unsigned int          release_max;      // time in ms
        unsigned short        release_size;     // # of particles released
        unsigned int          lifespan;         // time in ms
        unsigned int          emitter_lifespan; // time in ms
        unsigned int          fade_in;          // time in ms
        unsigned int          fade_out;         // time in ms
        unsigned int          color_start;      // COLORREF
        unsigned int          color_end;        // COLORREF
        float                 opacity;
...
#pragma pack (pop, aw_api)            // Restore structure packing alignment
    ...
    AWAPI int   aw_init_bind(int build, unsigned int Addr);
    ...
    AWAPI int   aw_create_resolved(unsigned int address, int port, void** instance);
    ...
    AWAPI int   aw_attrib_type(AW_ATTRIBUTE a);
    AWAPI char* aw_attrib_name(AW_ATTRIBUTE a);
    AWAPI wchar_t* aw_attrib_nameW(AW_ATTRIBUTE a);
    AWAPI int   aw_attrib_find_by_name(const char* value);
    AWAPI int   aw_attrib_find_by_nameW(const wchar_t* value);
    ...
    AWAPI int   aw_listen(int channels);
    AWAPI int   aw_say_channel(const char* message, int channel);
    AWAPI int   aw_say_channelW(const wchar_t* message, int channel);
    ...
    AWAPI int   aw_citizen_attributes_by_email(const char* email);
    AWAPI int   aw_citizen_attributes_by_emailW(const wchar_t* email);
    ...
    AWAPI int   aw_citizen_title_lookup(int citizen);
    ...
    AWAPI int   aw_shopitem_list(int type, const char* category, const char* description);
    AWAPI int   aw_shopitem_listW(int type, const wchar_t* category, const wchar_t* description);
    ...
    AWAPI int   aw_terrain_query(int page_x, int page_z, unsigned int sequence);
    ...
    AWAPI int   aw_object_zone_set(
        ...
        float gravity, float friction, unsigned short flags, unsigned int color,
    ...
    AWAPI int   aw_object_particles_set(
        ...
        unsigned int release_min, unsigned int release_max, unsigned short release_size,
        unsigned int lifespan, unsigned int emitter_lifespan,
        unsigned int fade_in, unsigned int fade_out,
    ...
    AWAPI int   aw_object_cloth_set(unsigned char type, unsigned char shape, unsigned int flags, unsigned char anchor_type,
        ...
        float opacity, unsigned int color, float time_till_static, float bending_stiffness, float stretching_stiffness,
        float compression_limit, float compression_stiffness, float hard_stretch_limit, float damping_coeff,
        float collision_response, float tear_factor, float attachment_response, float attachment_tear_factor, float min_adhere_velocity,
    ...
    AWAPI int   aw_traffic_jam(int type, unsigned int* queue_size, unsigned int* queue_length);
    ...
    AWAPI int   aw_unzip(unsigned char* data_out, unsigned int* len_out,
        unsigned char* data_in, unsigned int len_in);
    AWAPI int   aw_ntohl(int in_addr);

    AWAPI void  aw_thread_lock_aquire();
    AWAPI void  aw_thread_lock_release();
    ...
    /* methods below are not currently available in the public SDK */
    ...
    AWAPI int   aw_telegram_get(void);
    AWAPI int   aw_telegram_journal_get(unsigned int timestamp_start, unsigned int timestamp_end);
    ...
    AWAPI int   aw_tunnel_set_resolved(unsigned int address, unsigned short port);
    ...
    AWAPI int   aw_proxy_set_resolved(unsigned int address, unsigned short port);
    ...
    AWAPI int   aw_voip_data(void* data1, unsigned int len1, void* data2, unsigned int len2,
                             void* data3, unsigned int len3, void* data4, unsigned int len4);
    ...
    AWAPI int   aw_voipcast_set_resolved(unsigned int address, unsigned short port);
    AWAPI int   aw_voipcast_ready(void);
    AWAPI int   aw_voipcast_update(void);
    ...
    AWAPI int   aw_purchase(int kind, int type, int costs);

    AWAPI int   aw_dialog();
    AWAPI int   aw_dialog_answer();
...
#define aw_attrib_name                aw_attrib_nameW
#define aw_attrib_find_by_name        aw_attrib_find_by_nameW
...
#define aw_citizen_attributes_by_email aw_citizen_attributes_by_emailW
#if defined(AW_BROWSER) || defined(AW_STATIC)
#define aw_shopitem_by_desc           aw_shopitem_by_descW
#define aw_shopitem_list              aw_shopitem_listW
#endif
